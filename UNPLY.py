...
def bot():
	...
	cek = raw_input(R + 'UNEMPLYEDHACKER' + W +'/' + R +'Bot ' + W + '>> ')
...
def main():
	cek = raw_input(R + 'UNEMPLYEDHACKER' + W +' >> ')
...
def getdata():
	...
	jmlgetdata.append("UNEMPLOYEDHACKER")
	main()
...
def search():
	...
	if target == '':
		...
		search()
	elif target.lower() in ['putriy.kaeysha','UNEMPLOYEDHACKER','bintari.s.rini','bintari.styo','bintari.setyo.9']:
